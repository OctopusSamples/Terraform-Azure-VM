...
$octopusServerUrl = #{Global.Base.Url]
$octopusApiKey = #{Global.Api.Key}
$octopusServerThumbprint = #{Global.Server.Thumbprint]
$registerInEnvironments = #{Octopus.Environment.Name}
$registerInRoles = "Windows"
